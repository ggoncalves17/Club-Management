...
export const listaInscricoesJogador = (
  ...
  axios
    .get(`${url}/jogadores/${id_elemento}/inscricoes/`, {
      withCredentials: true,
    })
    .then((res) => {
      console.log("Resposta do Backend: ", res.data);
...
export const adicionaInscricaoEpoca = (
  ...
  axios
    .post(
      `${url}/jogadores/${id_jogador}/inscricoes/`,
      {
        id_epoca: id_epoca,
      },
      {
...
export const removeInscricao = (
  ...
  axios
    .delete(`${url}/jogadores/${id_inscricao}/inscricoes/`, {
      withCredentials: true,
      headers: {
        "X-CSRFToken": Cookies.get("csrftoken"),
      },
...
export const editaInscricaoEpoca = (
  ...
  axios
    .put(
      `${url}/jogadores/${id_inscricao}/editar/`,
      {
...
export const uploadDocumentosInscricao = (
  ...
  axios
    .put(`${url}/jogadores/${id_inscricao}/inscricoes/documentos/`, formData, {
      withCredentials: true,
      headers: {
        "X-CSRFToken": Cookies.get("csrftoken"),
